...
lnumvar<-c("label",numvar)
train_num<-train_nore[,lnumvar]
test_num<-test_nore[,numvar]
...
write.table(out,file = "mysubmission2.txt",row.names = FALSE,sep = ",")
